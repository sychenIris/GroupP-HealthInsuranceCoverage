...
In this project, we present a _state-level overview_ of the expansion of health insurance in the United States and its effects on health outcomes and cost outcomes, from 2008 to 2015 under President Obama's term. One of the hallmarks of Obama's presidency was the passage and implementation of the __Affordable Care Act (ACA)__ to increase health insurance coverage and regulate healthcare provision to protect consumers' rights.
...
aca_general_raw <- read_excel("/Users/gracekongyx/Documents/*6_Data Science/QMSS G4063 Data Visualization/Final Project/Data/states_aca_general.xlsx", sheet=2, col_names=FALSE)

# States health outcomes
health_ind_raw <- read_excel("/Users/gracekongyx/Documents/*6_Data Science/QMSS G4063 Data Visualization/Final Project/Data/states_health_ind.xlsx", sheet=4, col_names=FALSE)

# Insurance coverage data
  # Long format
insurance_long <- read_excel("/Users/gracekongyx/Documents/*6_Data Science/QMSS G4063 Data Visualization/Final Project/Data/insurance-clean.xlsx", sheet=1, col_names=TRUE)
  # Wide format
insurance <- read_excel("/Users/gracekongyx/Documents/*6_Data Science/QMSS G4063 Data Visualization/Final Project/Data/insurance-clean.xlsx", sheet=2, col_names=TRUE)

# Demographic information
demographics1 <- read.csv("/Users/gracekongyx/Documents/*6_Data Science/QMSS G4063 Data Visualization/Final Project/Data/Population_Age_Income.csv", header = TRUE)
  # Provided with Assignment 4 (want the yearly population data)
demographics2 <- read_excel("/Users/gracekongyx/Documents/*6_Data Science/QMSS G4063 Data Visualization/Final Project/Data/PopulationEstimates.xls")

# Election Results
election <- read_excel("/Users/gracekongyx/Documents/*6_Data Science/QMSS G4063 Data Visualization/Final Project/Data/US_Presidential_Results_by_State_1828-2016.xlsx", sheet=2, col_names=FALSE)
```
